 ...
 *   1. WAKATIME_TOKEN_CIPHER_PASSWORD / TOKEN_CIPHER_PASSWORD env var
...
function _getEncryptorData() {
  const cipherPassword = process.env.WAKATIME_TOKEN_CIPHER_PASSWORD || process.env.TOKEN_CIPHER_PASSWORD
  const cipherLabel = process.env.WAKATIME_TOKEN_CIPHER_LABEL ||
  ...
  const cipherFile = process.env.WAKATIME_TOKEN_CIPHER_FILE ||
